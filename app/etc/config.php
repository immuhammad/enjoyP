...
return [
    'modules' => [
        ...
        'Consultera_Ambasdor' => 1,
        'Consultera_Prelaunch' => 1,
        'Consultera_Seller' => 1,
        'Mageplaza_Core' => 1,
        'Mageplaza_Ambasdor' => 0,
        ...
        'Webkul_Customattribute' => 1,
        'Webkul_B2BMarketplace' => 1,
        'Webkul_MarketplaceBaseShipping' => 1,
        'Webkul_MpAdvancedBookingSystem' => 1,
        'Webkul_MpMassUpload' => 1,
        'Webkul_MpRmaSystem' => 1,
        'Webkul_MpServiceFee' => 1,
        'Webkul_MpStripe' => 1,
        'Webkul_MpVendorAttributeManager' => 1,
        'Webkul_Mpmembership' => 1,
        'Webkul_Mpperproductshipping' => 1,
        'Webkul_Mpquotesystem' => 1,
