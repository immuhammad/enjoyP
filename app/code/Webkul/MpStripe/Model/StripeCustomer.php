...
/**
 * StripeCustomer Data Class
 */
class StripeCustomer extends AbstractModel implements IdentityInterface, StripeCustomerInterface
{

    public const NOROUTE_ENTITY_ID = 'no-route';

    public const CACHE_TAG = 'webkul_mpstripe_stripecustomer';

    /**
     * @var string
     */
    protected $_cacheTag = 'webkul_mpstripe_stripecustomer';

    /**
     * @var string
     */
    protected $_eventPrefix = 'webkul_mpstripe_stripecustomer';
     ...
     *
     * @param int $entityId
     * @return Webkul\MpStripe\Model\StripeCustomerInterface
     */
