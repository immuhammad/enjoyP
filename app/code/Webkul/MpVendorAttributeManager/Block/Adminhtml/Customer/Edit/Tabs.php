...
class Tabs extends Generic implements TabInterface
{
    ...
    /**
     * @var \Webkul\Marketplace\Model\SellerFactory $sellerFactory
     */
    ...
    /**
     * Function get Marketplace User Collection
     *
    ...
    /**
     * Get Attributes Collection by Group Id
     *
     * @param int $groupId
    ...
    public function getFormHtml()
    {
        ...
        $html .= $this->getLayout()->createBlock(
            \Webkul\MpVendorAttributeManager\Block\Adminhtml\Customer\Edit\Button::class
        )->toHtml();
    ...
    public function _afterToHtml($html)
    {
        if (!$this->attributesShown) {
            $html = $html."<p>".__("Sorry! No attributes are assigned to Vendor.")."</p>";
        }
        return $html.'<script>
            //<![CDATA[
