...
namespace Webkul\Mpquotesystem\Model\ResourceModel\QuoteConfig;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Webkul\Mpquotesystem\Model\QuoteConfig::class,
            \Webkul\Mpquotesystem\Model\ResourceModel\QuoteConfig::class
        );
    ...
    public function setTableRecords($ids, $columnData)
    {
        return $this->getConnection()->update(
            $this->getTable('marketplace_quote_config'),
            $columnData,
            $where = $ids
        );
    }
