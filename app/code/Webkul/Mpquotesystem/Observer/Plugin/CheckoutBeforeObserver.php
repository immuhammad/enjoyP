...
/**
 * Webkul Marketplace CheckoutBeforeObserver Observer.
 */
class CheckoutBeforeObserver
{
    /**
     * @var CheckoutSession
     */
     ...
     *
     * @param \Webkul\Marketplace\Observer\CheckoutBeforeObserver $subject
     * @param callable                                            $proceed
     *
     * @return void
     */
    public function aroundExecute(
        \Webkul\Marketplace\Observer\CheckoutBeforeObserver $subject,
        callable $proceed
    ) {
        $flag = 1;
        try {
            if ($this->_marketplaceHelperData->getAllowProductLimit()) {
                ...
                foreach ($items as $item) {
                    if ($item->getParentItemId()==null && $item->getItemId()!=null) {
     ...
     * @return void
     */
    public function setDiscount($item)
    {
