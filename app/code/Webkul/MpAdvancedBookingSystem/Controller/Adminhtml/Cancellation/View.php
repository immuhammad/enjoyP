...
class View extends Action
{
    ...
    public function execute()
    {
        ...
        */
        ...
        $resultPage->setActiveMenu('Webkul_MpAdvancedBookingSystem::mpadvancedbookingsystem');
        $requestId = $this->getRequest()->getParam('request_id');
        $resultPage->getConfig()->getTitle()->prepend(__('Cancellation Request # %1', $requestId));
