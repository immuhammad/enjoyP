...
define(
    ...
    $.widget('mpdefaultbooking.mpdefaultbooking', {
        options: {},
        _create: function () {
            var dateFormat = "yy-mm-dd";
            
            var bookingDateFrom = $("#start_date").datepicker({
                showsTime: false,
            ...
            var bookingDateTo = $("#end_date").datepicker({
                showsTime: false,
                hideIfNoPrevNext: true,
                minDate: new Date(),
                dateFormat: 'yy-mm-dd',
                ...
                $(document).on('click', '.wk-btn', function () {
                    ...
                    html.append(
                        ...
                        .append(
                            ...
                            .append(
                                $('<div>', { class : 'wk-input-col' })
                                .append('<input class="input-text" readonly type="text" name="info[start][hour]['+selectCounts+']" value="1">')
                                .append($('<div>', { class : 'wk-dec wk-obmd-h-dec', text : '-' }))
                                .append($('<div>', { class : 'wk-inc wk-obmd-h-inc', text : '+' }))
                            )
                            .append(
                                $('<div>', { class : 'wk-input-col' })
                                .append('<input class="input-text" readonly type="text" name="info[start][minute]['+selectCounts+']" value="0">')
                    ...
                    html.append(
                        ...
                        .append(
                            ...
                            .append(
                                $('<div>', { class : 'wk-input-col' })
                                .append('<input class="input-text" readonly type="text" name="info[end][hour]['+selectCounts+']" value="1">')
                                .append($('<div>', { class : 'wk-dec wk-obmd-h-dec', text : '-' }))
                                .append($('<div>', { class : 'wk-inc wk-obmd-h-inc', text : '+' }))
                            )
                            .append(
                                $('<div>', { class : 'wk-input-col' })
                                .append('<input class="input-text" readonly type="text" name="info[end][minute]['+selectCounts+']" value="0">')
                                .append($('<div>', { class : 'wk-dec wk-obmd-m-dec', text : '-' }))
                                .append($('<div>', { class : 'wk-inc wk-obmd-m-inc', text : '+' }))
                            )
                        )
    ...
    return $.mpdefaultbooking.mpdefaultbooking;
    }
);