 ...
 */
namespace Webkul\MpAdvancedBookingSystem\Model\ResourceModel\Info;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Webkul\MpAdvancedBookingSystem\Model\Info::class,
            \Webkul\MpAdvancedBookingSystem\Model\ResourceModel\Info::class
        );
    ...
    /**
     * Retrieve all product_id for collection
     *
     * @param int|string $limit
     * @param int|string $offset
     * @return array
